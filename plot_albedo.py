...
# Generate fake data
observation = sheet.col_values(2)[1:]#表示取第0-第365行
ww_data     = sheet.col_values(1)[1:]
#########################################
fig         = plt.figure(figsize=(6,5))#设置图形界面的大小
ax          = fig.add_subplot(111)
#########################################
plt.scatter(observation, ww_data, marker='o', color='b', s=7)
...
#########################################
plt.xlabel(u'MOD10A1 积雪反照率',fontproperties='SimHei')#fontproperties=font
plt.ylabel(u'融合后的积雪反照率',  fontproperties='SimHei')
##############################################
plt.legend()
# batt.plot()
plt.show()
fig.savefig('ronghe_albedo.jpg',dpi=600)
print 'end'